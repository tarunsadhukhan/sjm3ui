// Types for the Inter Card SQC page (R-08-07A — Inter Card / Tow Breaker / Hopper sliver wt).
// Shapes mirror the backend contract in vowerp3be/src/juteSQC/card_sliver_wt.py.
...
/** Per-section footer block recomputed at read (mean of per-row stats). */
...
export type CardSliverTableRow = Omit<CardSliverRow, "weights" | "mr_pcts"> & {
