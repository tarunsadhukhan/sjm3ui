...
export type AssortingFilterValues = {
	fromDate: string;
	toDate: string;
};
...
type Props = {
	open: boolean;
	onClose: () => void;
	onApply: (values: AssortingFilterValues) => void;
	initial?: Partial<AssortingFilterValues>;
	title?: string;
};

export default function AssortingFilterDialog({
	open,
	onClose,
	onApply,
	initial,
