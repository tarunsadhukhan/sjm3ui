...
const apiRoutesPortalMasters = {
    ...
    JUTE_QUALITY_ENTRY_EDIT_SETUP: `${API_URL}/juteQualityEntry/jute_quality_edit_setup`,
    JUTE_QUALITY_ENTRY_CREATE: `${API_URL}/juteQualityEntry/jute_quality_create`,
    JUTE_QUALITY_ENTRY_EDIT: `${API_URL}/juteQualityEntry/jute_quality_edit`,
    ...
    JUTE_MR_OPEN_POS: `${API_URL}/juteMR/get_open_pos`,
    JUTE_MR_SUPPLIERS: `${API_URL}/juteMR/get_suppliers`,
    JUTE_MR_PARTIES: `${API_URL}/juteMR/get_parties`,
    ...
    // Jute SQC - Spreader Roll Weight (DELETE is a base path; caller appends /${id})
    SPREADER_ROLL_WT_SETUP: `${API_URL}/juteSQC/get_spreader_roll_wt_setup`,
    SPREADER_ROLL_WT_CREATE: `${API_URL}/juteSQC/create_spreader_roll_wt`,
    SPREADER_ROLL_WT_TABLE: `${API_URL}/juteSQC/get_spreader_roll_wt_table`,
    SPREADER_ROLL_WT_BY_ID: `${API_URL}/juteSQC/get_spreader_roll_wt_by_id`,
    SPREADER_ROLL_WT_BY_DATE: `${API_URL}/juteSQC/get_spreader_roll_wt_by_date`,
    SPREADER_ROLL_WT_DELETE: `${API_URL}/juteSQC/spreader_roll_wt_delete`,
    // Jute SQC - Spreader Sliver Weight
    SPREADER_SLIVER_WT_SETUP: `${API_URL}/juteSQC/get_spreader_sliver_wt_setup`,
    SPREADER_SLIVER_WT_CREATE: `${API_URL}/juteSQC/create_spreader_sliver_wt`,
    SPREADER_SLIVER_WT_TABLE: `${API_URL}/juteSQC/get_spreader_sliver_wt_table`,
    SPREADER_SLIVER_WT_BY_ID: `${API_URL}/juteSQC/get_spreader_sliver_wt_by_id`,
    ...
    // Jute SQC - Breaker Card Sliver Weight
    BREAKER_CARD_SWT_SETUP: `${API_URL}/juteSQC/get_breaker_card_swt_setup`,
    BREAKER_CARD_SWT_CREATE: `${API_URL}/juteSQC/create_breaker_card_swt`,
    BREAKER_CARD_SWT_BY_DATE: `${API_URL}/juteSQC/get_breaker_card_swt_by_date`,
    BREAKER_CARD_SWT_TABLE: `${API_URL}/juteSQC/get_breaker_card_swt_table`,
    BREAKER_CARD_SWT_BY_ID: `${API_URL}/juteSQC/get_breaker_card_swt_by_id`,
    BREAKER_CARD_SWT_DELETE: `${API_URL}/juteSQC/breaker_card_swt_delete`,
    // Jute SQC - Inter Card Sliver Weight
    CARD_SLIVER_WT_SETUP: `${API_URL}/juteSQC/get_card_sliver_wt_setup`,
    CARD_SLIVER_WT_CREATE: `${API_URL}/juteSQC/create_card_sliver_wt`,
    CARD_SLIVER_WT_BY_DATE: `${API_URL}/juteSQC/get_card_sliver_wt_by_date`,
    CARD_SLIVER_WT_TABLE: `${API_URL}/juteSQC/get_card_sliver_wt_table`,
    CARD_SLIVER_WT_BY_ID: `${API_URL}/juteSQC/get_card_sliver_wt_by_id`,
    CARD_SLIVER_WT_DELETE: `${API_URL}/juteSQC/card_sliver_wt_delete`,
    // Jute SQC - Finisher Drawing Sliver Weight
    FIN_DRAW_SLIVER_WT_SETUP: `${API_URL}/juteSQC/get_fin_draw_sliver_wt_setup`,
    FIN_DRAW_SLIVER_WT_CREATE: `${API_URL}/juteSQC/create_fin_draw_sliver_wt`,
    FIN_DRAW_SLIVER_WT_BY_DATE: `${API_URL}/juteSQC/get_fin_draw_sliver_wt_by_date`,
    FIN_DRAW_SLIVER_WT_TABLE: `${API_URL}/juteSQC/get_fin_draw_sliver_wt_table`,
    FIN_DRAW_SLIVER_WT_BY_ID: `${API_URL}/juteSQC/get_fin_draw_sliver_wt_by_id`,
    FIN_DRAW_SLIVER_WT_DELETE: `${API_URL}/juteSQC/fin_draw_sliver_wt_delete`,
    // Jute SQC - Drawhead Sliver Weight
    DRAW_SLIVER_WT_SETUP: `${API_URL}/juteSQC/get_draw_sliver_wt_setup`,
    DRAW_SLIVER_WT_CREATE: `${API_URL}/juteSQC/create_draw_sliver_wt`,
    DRAW_SLIVER_WT_BY_DATE: `${API_URL}/juteSQC/get_draw_sliver_wt_by_date`,
    DRAW_SLIVER_WT_TABLE: `${API_URL}/juteSQC/get_draw_sliver_wt_table`,
    DRAW_SLIVER_WT_BY_ID: `${API_URL}/juteSQC/get_draw_sliver_wt_by_id`,
    DRAW_SLIVER_WT_DELETE: `${API_URL}/juteSQC/draw_sliver_wt_delete`,
    // Jute SQC - Spinning (entry / count / RHMR / QR-CV; DELETEs are base paths)
    SPINNING_SQC_ENTRY_SETUP: `${API_URL}/juteSQC/sqc_entry_setup`,
    SPINNING_SQC_ENTRY_SAVE: `${API_URL}/juteSQC/sqc_entry_save`,
    SPINNING_SQC_ENTRY_BY_DATE: `${API_URL}/juteSQC/sqc_entry_by_date`,
    ...
    // Jute SQC - Yarn TPI (R-08-17)
    YARN_TPI_SETUP: `${API_URL}/juteSQC/yarn_tpi_setup`,
    YARN_TPI_SAVE: `${API_URL}/juteSQC/yarn_tpi_save`,
    YARN_TPI_BY_DATE: `${API_URL}/juteSQC/yarn_tpi_by_date`,
    YARN_TPI_TABLE: `${API_URL}/juteSQC/yarn_tpi_table`,
    YARN_TPI_DELETE: `${API_URL}/juteSQC/yarn_tpi_delete`,
    // Jute SQC - Yarn QR-CV Special (R-08-15A)
    QR_CV_15A_SETUP: `${API_URL}/juteSQC/qr_cv_15a_setup`,
    QR_CV_15A_SAVE: `${API_URL}/juteSQC/qr_cv_15a_save`,
    QR_CV_15A_BY_DATE: `${API_URL}/juteSQC/qr_cv_15a_by_date`,
    QR_CV_15A_TABLE: `${API_URL}/juteSQC/qr_cv_15a_table`,
    QR_CV_15A_DELETE: `${API_URL}/juteSQC/qr_cv_15a_delete`,
    // Jute SQC - Finishing (process grid)
    ...
    // Target maps (spng/beaming/weaving/finishing; EDIT/DELETE are base paths, caller appends /${id})
    ...
    BIO_ATT_MAX_LOG_ID: `${API_URL}/hrmsMasters/bio_att_max_log_id`,
    BIO_ATT_ETRACK: `${API_URL}/hrmsMasters/bio_att_etrack`,
    BIO_ATT_ETRACK_PROCESS: `${API_URL}/hrmsMasters/bio_att_etrack_process`,
    BIO_ATT_ETRACK_PROCESS_D: `${API_URL}/hrmsMasters/bio_att_etrack_process_d`,
    ...
    // Mis Entries - Yarn Purchase (tbl_yarn_transaction) endpoints
    YARN_PURCHASE_LIST: `${API_URL}/misEntries/yarn_purchase_list`,
    YARN_PURCHASE_BY_ID: `${API_URL}/misEntries/yarn_purchase_by_id`,
    YARN_PURCHASE_SETUP: `${API_URL}/misEntries/yarn_purchase_setup`,
    YARN_PURCHASE_CREATE: `${API_URL}/misEntries/yarn_purchase_create`,
    YARN_PURCHASE_UPDATE: `${API_URL}/misEntries/yarn_purchase_update`,

    // Mis Entries - Electricity / DG (tbl_other_entries) endpoints
    ELECTRICITY_DG_LIST: `${API_URL}/misEntries/electricity_dg_list`,
    ELECTRICITY_DG_BY_ID: `${API_URL}/misEntries/electricity_dg_by_id`,
    ELECTRICITY_DG_SETUP: `${API_URL}/misEntries/electricity_dg_setup`,
    ELECTRICITY_DG_CREATE: `${API_URL}/misEntries/electricity_dg_create`,
    ELECTRICITY_DG_UPDATE: `${API_URL}/misEntries/electricity_dg_update`,

    // MIS Reports - 8-period MIS report
    MIS_REPORT: `${API_URL}/misReports/mis_report`,
    MIS_REPORT_EXCEL: `${API_URL}/misReports/mis_report_excel`,
    MIS_REPORT_PDF: `${API_URL}/misReports/mis_report_pdf`,
};
